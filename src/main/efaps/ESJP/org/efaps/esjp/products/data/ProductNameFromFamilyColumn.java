/*
 * Copyright 2003 - 20196 The eFaps Team
 *
 ...
 */
@EFapsUUID("b85bf4d1-44d8-40b3-868b-650a247341f7")
@EFapsApplication("eFapsApp-Products")
public class ProductNameFromFamilyColumn
    ...
    implements IColumnValue, IColumnValidate
{
     ...
     */
    private static final Logger LOG = LoggerFactory.getLogger(ProductNameFromFamilyColumn.class);
        ...
        throws EFapsException
    {
        ...
        if (column != null) {
            ...
            if (famInst != null && famInst.isValid()) {
                final var suffix = new Product().getSuffix4Family(_parameter, famInst);
                final var familyCode = new ProductFamily().getCode(_parameter, famInst);
                ret = familyCode + "." + suffix;
            }
        } else {
            ProductNameFromFamilyColumn.LOG.error("Missing property 'Column'.");
        }
        return ret;
    }
        ...
        throws EFapsException
    {
        ...
        if (_def instanceof AttrDef) {
            ...
            if (column != null) {
                ...
                final Instance famInst = ProductFamily.getFamilyInstance4Code(_parameter, family);
                if (famInst != null && famInst.isValid()) {
                    ProductNameFromFamilyColumn.LOG.debug("Row: {} - {}", _idx, famInst);
                    ret = true;
                } else {
                    ProductNameFromFamilyColumn.LOG.warn("no Instance found in Row: {} - {}", _idx, _def);
                    ret = false;
                }
            } else {
                ProductNameFromFamilyColumn.LOG.error("Missing property 'Column'.");
            ...
            ProductNameFromFamilyColumn.LOG.error("Validation only works for AttrDef.");
            ret = false;
        }
        return ret;
    }
